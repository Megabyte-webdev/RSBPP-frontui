...
const UpdateScheduleForm = ({ meetingCode, list }) => {
    ...
    const [details, setDetails] = useState({
        ...
        instructor_id: list?.instructor_id,
        course_id: list?.course_id,
        meeting_code: list?.meeting_code,
    })
    ...
    return (
        <>
            <button className="btn btn-outline-warning btn-light" onClick={handleShow}>
                Update
            </button>
