...
<p> No matter the expertise level you intend to pursue, we always have the right programme for you</p>
                ...
                <button onClick={()=>{navigate('/login'); scrollTo(0,0)}} className="bg-[#8B0002] text-sm sm:text-base text-gray-600 px-8 py-3 mt-6 hover:scale-105 transition-all">Register now</button>
            </div>
            {/* --------Right Side------ */}
