...
import img from '../../assets/preview.svg'
    ...
    return (
        <div className='font-[Ripple-Bold] font-bold flex flex-col md:flex-row md:justify-between gap-4 p-[4%] lg:px-[5%] my-5'>
            ...
            <div className='flex-1 w-full md:w-3/4'>
                <p className='text-sm md:text-[16px] text-[#888] mb-3 font-medium'>{details?.description}</p>
                <div
            ...
            <div className='w-full md:w-1/3 flex flex-col items-end'>
                <p
                    className={`w-full flex gap-2 items-center md:w-[90%] text-sm text-black border border-gray-700 px-3 py-4 underline cursor-pointer ${loading ? 'cursor-not-allowed opacity-50' : ''}`}
                ...
                <p className='w-full flex gap-2 items-center md:w-[90%] text-sm text-black border border-gray-700 px-3 py-4'>
                <img src={img} className="w-4" /> ${details?.price}
                </p>
            </div>
        </div>
    );
