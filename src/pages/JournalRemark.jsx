...
const JournalJournal = () => {
  ...
  const handleRemark = () => {
    ...
    let details = { id: journal?.id, remark };
    setLoading(true);
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-6 w-full max-w-2xl">
        ...
        {/* Remark Section */}
        <div className="w-full">
          <label className="block text-gray-700 font-medium mb-2">Lecturer's Comment</label>
          <textarea
            ref={remarkRef}
...
const DataField = ({ label, value }) => (
  <div className="flex flex-col h-full">
    ...
    <p className="p-2 border bg-gray-100 rounded-md flex-1">{value || "N/A"}</p>
  </div>
);

export default JournalJournal;
