        ...
        <div className='flex flex-col p-3 p-md-5 min-vh-100 poppins' style={{ backgroundColor: "hsla(219, 50%, 95%, .3)" }}>
                ...
                <div className='font-medium my-2'>
                    ...
                    <section className='flex justify-between items-center gap-2 border-[1px] border-red-500 rounded-md p-3'>
                        ...
                        <div className='flex flex-col gap-y-2'>
                            <p className='text-[16px] capitalize'>Faculty of business communication and finance</p>
                            <p className='text-sm text-gray-600 capitalize'>Select course</p>
                        </div>
            ...
            <div className='font-medium my-2'>
                    ...
                    <section className='flex justify-between items-center gap-2 border-[1px] border-red-500 rounded-md p-3'>
                        ...
                        <div className='flex flex-col gap-y-2'>
                            <p className='text-[16px] capitalize'>Faculty of business communication and finance</p>
                            <p className='text-sm text-gray-600 capitalize'>Select Faculty</p>
                        </div>
                        <small className='font-bold text-xs text-red-500 ml-auto'>Prof Samuel Attong</small>
                        <p className='pl-4 text-red-500'><IoIosArrowDown size='20' /></p>
                        {/* drop selection view end*/}
                    </section>
                    {/* dropcontainer end */}
                </div>
                ...
                <div className='font-medium my-2'>
                    ...
                    <section className='flex justify-between items-center gap-2 border-[1px] border-red-500 rounded-md p-3'>
                        ...
                        <div className='flex-1 flex flex-col gap-y-2'>
                            <p className='text-[16px] capitalize'>Remark</p>
