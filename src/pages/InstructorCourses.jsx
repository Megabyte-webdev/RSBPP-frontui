...
const InstructorCourses = () => {
    ...
    const offLineCourse = getAllCourses.data?.filter((course) => course.course_type === "offline" && course.created_by_id == userId)
    const onLineCourse = getAllCourses.data?.filter((course) => course.course_type === "online" && course.created_by_id == userId)
